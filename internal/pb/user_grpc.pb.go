...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserDeleteRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserDeleteRequest) (*UserResponse, error) {
