...
type UserServiceClient interface {
	...
	DeleteUser(ctx context.Context, in *UserDeleteRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserDeleteRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type UserServiceServer interface {
	...
	DeleteUser(context.Context, *UserDeleteRequest) (*User, error)
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserDeleteRequest) (*User, error) {
